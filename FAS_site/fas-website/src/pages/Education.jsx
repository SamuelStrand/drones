      ...
      <div className="pt-32 pb-20 bg-white dark:bg-zinc-950 min-h-screen text-zinc-900 dark:text-white transition-colors duration-500">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-8">
            ...
            {/* Group Training */}
            <div className="flex flex-col h-full space-y-6 group">
              <div className="text-center md:text-left px-2">
                <h2 className="text-xl md:text-2xl font-semibold mb-2 tracking-tight">
                  {t('education.group.title')}
                </h2>
                <p className="text-blue-600 dark:text-zinc-500 text-sm uppercase tracking-widest font-bold">
                  {t('education.group.price')}
                </p>
              </div>
              
              <div className="relative flex-grow overflow-hidden rounded-2xl border border-zinc-200 dark:border-white/10 bg-zinc-50/50 dark:bg-zinc-900/30 p-8 shadow-sm group-hover:shadow-md dark:shadow-none transition-all duration-500">
                {/* Glow for Light/Dark Mode */}
            ...
            <div className="flex flex-col h-full space-y-6 group">
              ...
              <div className="relative flex-grow overflow-hidden rounded-2xl border border-zinc-200 dark:border-white/10 bg-zinc-50/50 dark:bg-zinc-900/30 p-8 shadow-sm group-hover:shadow-md dark:shadow-none transition-all duration-500">
                 <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-blue-500/5 dark:bg-blue-900/10 blur-[80px] pointer-events-none" />

...
export default function Footer() {
  ...
  return (
    <footer className="bg-zinc-950 border-t border-white/5 pt-20 pb-10 px-10">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
        ...
        {/* Products Column */}
        <div>
          <h4 className="text-white font-bold mb-6">{t('footer.col_products')}</h4>
          <ul className="text-zinc-500 text-sm space-y-4">
            <li>
              <Link to="/drones" className="hover:text-white transition">EVTOL</Link>
            </li>
            <li>
              <Link to="/drones" className="hover:text-white transition">Multi-Rotor</Link>
            </li>
          </ul>
        </div>
        ...
        {/* Support Column */}
        <div>
          <h4 className="text-white font-bold mb-6">{t('footer.col_support')}</h4>
          <ul className="text-zinc-500 text-sm space-y-4">
        ...
        <div>
          <h4 className="text-white font-bold mb-6">{t('footer.col_follow')}</h4>
          <div className="flex flex-col gap-5">
            ...
            <a 
              ...
              className="group flex items-center gap-3 text-zinc-400 hover:text-[#25D366] transition-all"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="group flex items-center gap-3 text-zinc-400 hover:text-[#0088cc] transition-all"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="transition-transform group-hover:scale-110">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="group flex items-center gap-3 text-zinc-400 hover:text-[#E4405F] transition-all"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="transition-transform group-hover:scale-110">
      ...
      <div className="max-w-7xl mx-auto border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 text-zinc-600 text-xs uppercase tracking-widest">
          <span className="hover:text-white cursor-pointer transition">{t('footer.legal.privacy')}</span>
          <span className="hover:text-white cursor-pointer transition">{t('footer.legal.terms')}</span>
        </div>
      </div>
    </footer>
  );
